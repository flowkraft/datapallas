...
public final class BuildHrPortalNext {

    private BuildHrPortalNext() {}

    public static PromptDefinition create() {
        return new PromptDefinition(
            "BUILD_HR_PORTAL_NEXT",
            "Write a Custom Data App — HR Payslips Portal (Next.js/Apollo)",
            ...
            List.of("custom-app", "hr-portal", "nextjs", "apollo"),
            "Seed Data / Apps",
            """
Apollo — this time I need an **HR payslips portal** for my employees. Think of it like a customer portal,
