...
public final class BuildBillingPortalGrails {

    private BuildBillingPortalGrails() {}

    public static PromptDefinition create() {
        return new PromptDefinition(
            "BUILD_BILLING_PORTAL_GRAILS",
            "Write My Own Billing Portal — My Data Model & Branding (Grails/Hermes)",
            "Your own billing portal — your invoices and branding; customers log in to view and pay.",
            List.of("custom-app", "billing-portal", "grails", "hermes"),
            "Seed Data / Apps",
            """
Hermes — I'd like my own **billing portal** for my company. Here's what it needs.
