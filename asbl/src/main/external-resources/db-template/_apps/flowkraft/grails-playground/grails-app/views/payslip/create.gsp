            ...
            <div class="card bg-base-100 border border-base-300">
                <div class="card-body">
                    <h2 class="card-title text-base">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline-block w-4 h-4 mr-2 text-base-content/60"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>New Payslip
                    </h2>
                    <g:form action="save" method="POST">
                        <!-- Payslip Details -->
                        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:0.75rem" class="mb-4">
                            <div>
                                <label class="label label-text">Payslip Number</label>
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button type="submit" id="btn-submit" class="btn btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline-block w-4 h-4 mr-1"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/></svg> Create Payslip
                            </button>
                        </div>
                    </g:form>
                </div>
