...
function SaveStatusIndicator() {
  ...
  switch (status as SaveStatus) {
    ...
    case "dirty":
      return render(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-2.5 h-2.5"><circle cx="12" cy="12" r="5" /></svg>, "Unsaved changes", "text-amber-600");
    case "saved":
      return render(
