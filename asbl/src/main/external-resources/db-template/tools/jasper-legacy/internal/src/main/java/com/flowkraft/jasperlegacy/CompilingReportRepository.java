 ...
 *
 * DataPallas's own engine carries its own copy of this class: the repository SPI
 * is identical between JasperReports 6 and 7, but the libraries are not, so the
