  ...
  <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaWebURL" [ngModel]="xmlSettings?.documentburster?.settings?.qualityassurance?.emailserver?.weburl"
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.weburl', $event)" class="input" />
      </div>
  ...
  <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaFromName" [ngModel]="xmlSettings?.documentburster?.settings?.qualityassurance?.emailserver?.name"
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.name', $event)" class="input" />
      </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaFromEmailAddress"
          ...
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.fromaddress', $event)" class="input" />
      </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaEmailServerHost"
          ...
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.host', $event)" class="input" />
      </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaUserName" [ngModel]="xmlSettings?.documentburster?.settings?.qualityassurance?.emailserver?.userid"
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.userid', $event)" class="input" />
      </div>
      ...
      <div style="grid-column:span 7">
        <div class="join">
          <input id="qaPassword"
            ...
            (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.userpassword', $event)" [type]="showQaPassword ? 'text' : 'password'" class="input join-item" />
    ...
    <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:1rem">
      ...
      <div style="grid-column:span 7">
        <input id="qaPort" [ngModel]="xmlSettings?.documentburster?.settings?.qualityassurance?.emailserver?.port"
          (ngModelChange)="setXmlPath('documentburster.settings.qualityassurance.emailserver.port', $event)" class="input" />
      </div>
